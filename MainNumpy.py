...
def main():
    ...
    train_data = config.PROCESSED_NUMPY_PATH + 'TrainingData.npy'
    val_data = config.PROCESSED_NUMPY_PATH + 'TestingData.npy'
    num_class = 3
    ...
    neuralnet.visionModel.save(config.TRAINED_MODELS_PATH +'ResNeSt_T0')
